...
void MainWindow::on_pushButtonGerar_clicked()
{
    try {
        ...
        ui->textEditBubbleSort->setText(obj->obterVetorBubbleSort());
        ...
        ui->textEditNExecucaoBS->setText(QString::number(obj->getExecucoesBS()));
        ...
        ui->textEditTempoBS->setText(QString::number(obj->TempoBubbleSort() / 1000, 'f', 3) + "µs");
